...
{
    internal class AccountDefault : IAccount
    {
        public AccountDefault(bool isMaster, bool isActive, string userName, string password, IEndpoint endpointLogin, IEndpoint endpointHub)
        {
            IsMaster = isMaster;
            IsActive = isActive;
            UserName = userName;
