...
public static class JobTimingExtension
{
    ...
    public static JobBuilderTimingExtensionModel TimingNow(this JobBuilderMessageExtensionModel jobBuilderExtension)
        => TimingNowAdd(jobBuilderExtension.Job);
    ...
    public static JobBuilderTimingExtensionModel TimingScheduleDelayed(this JobBuilderPublisherExtensionModel jobBuilderPublisherExtension, int delayedSecond)
        => TimingScheduleAdd(jobBuilderPublisherExtension.Job, ScheduleTypeEnum.Delayed, delayedSecond, DateToCron(DateTime.Now.AddSeconds(delayedSecond)), 1);
    ...
    //    => TimingScheduleAdd(jobBuilderExtension.Job, ScheduleTypeEnum.Delayed, delayedSecond, DateToCron(DateTime.Now.AddSeconds(delayedSecond)), 1);
    ...
    public static JobBuilderTimingExtensionModel TimingScheduleDelayed(this JobBuilderMessageExtensionModel jobBuilderExtension, int delayedSecond)
        => TimingScheduleAdd(jobBuilderExtension.Job, ScheduleTypeEnum.Delayed, delayedSecond, DateToCron(DateTime.Now.AddSeconds(delayedSecond)), 1);
    public static JobBuilderTimingExtensionModel TimingScheduleRecurrent(this JobBuilderMessageExtensionModel jobBuilderExtension, string cronTime, int? executeCountMax = null)
        => TimingScheduleAdd(jobBuilderExtension.Job, ScheduleTypeEnum.Recurrent, null, cronTime, executeCountMax);
    ...
    public static JobBuilderTimingExtensionModel TimingTriggerWhenDone(this JobBuilderMessageExtensionModel jobBuilderExtension, Guid jobId, bool errorWorkflowStop)
        => TimingTriggerAdd(jobBuilderExtension.Job, jobId, errorWorkflowStop);
    ...
    //todo DateToCron kullanırkenDateTime.Now kullanmışım bu yapı evrensel olmalı
