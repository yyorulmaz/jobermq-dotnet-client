...
namespace JoberMQ.Client.Net.Implementation.Account.Default
{
    ...
    {
        public DfAccount(bool isMaster, bool isActive, string userName, string password, IEndpoint endpointLogin, IEndpoint endpointHub)
        {
